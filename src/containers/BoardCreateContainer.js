  ...
  render() {
    return (
      <View>
        ...
        <TextInput style={{ borderWidth: 1, fontSize: 20, height: 50, margin: 20, marginTop: 30 }}
          placeholder="제목"
          onChangeText={text => this.setState({ title: text })}
        />
        <TextInput style={{ borderWidth: 1, minHeight: 300, fontSize: 20, margin: 20, marginTop: 30}}
          placeholder="내용"
          multiline={true}
